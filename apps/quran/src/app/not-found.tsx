 ...
 * wired up in the dynamic Surah/Juz/Mushaf-page routes (an out-of-range
  ...
  return (
    <div style={{ maxWidth: "32rem", margin: "0 auto", padding: "4rem 1rem", textAlign: "center" }}>
      ...
      <p style={{ color: "var(--color-text-muted)" }}>
        That page doesn&apos;t exist — it may be an invalid Surah, Juz, or Mushaf page number, or a broken link.
      </p>
