...
// Matches globals.css's --color-paper (light theme) — OG images are
// static files with no access to CSS custom properties, so this is
// duplicated deliberately rather than shared (same approach as
// apps/quran's copy, which duplicates its own --color-bg the same way).
const IVORY_BACKGROUND = "#faf8f3";
